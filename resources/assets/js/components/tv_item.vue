...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://www.zetin.cn/api/img/' + id).then((response) => {
            ...
            * */
            deleteTv(id) {
                this.$ajax.delete('http://www.zetin.cn/api/tv/' + id).then((response) => {
            ...
            * */
            updateTv() {
                this.$refs['tv'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://www.zetin.cn/api/tv', this.tv).then((response) => {
