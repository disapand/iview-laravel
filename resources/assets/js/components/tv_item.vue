...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://zetin.cn/api/img/' + id).then((response) => {
            ...
            * */
            deleteTv(id) {
                this.$ajax.delete('http://zetin.cn/api/tv/' + id).then((response) => {
            ...
            * */
            updateTv() {
                this.$refs['tv'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://zetin.cn/api/tv', this.tv).then((response) => {
        ...
        created() {
            ...
            * */
            if (this.$route.params.id) {
                this.$ajax.get('http://zetin.cn/api/tv/' + this.$route.params.id + '?include=televisionResourcesImgs').then((response) => {
