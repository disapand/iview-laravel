            ...
            <Card style="width: 30%; display: inline-block; vertical-align: top;">
                ...
                <form-item>
                    <upload multiple type="drag"
                            name="img"
                            action="https://iview-laravel.test/api/caseImg"
    ...
    export default {
        ...
        created() {
            if (this.$route.params.id) {
                this.$ajax.get('https://iview-laravel.test/api/case/' + this.$route.params.id + '?include=Imgs').then((response) => {
        ...
        methods: {
            ...
            * */
            ...
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('https://iview-laravel.test/api/caseImg/' + id).then((response) => {
                ...
                this.$Modal.info({
                    ...
                    render: (h) => {
                        return h('div', [
                            h('upload', {
                                props: {
                                    action: 'https://iview-laravel.test/api/caseImgUpdate',
                                    type: 'drag',
                                    name: 'img',
                                    data: this.img,
                                    'show-upload-list': false,
            ...
            * */
            ...
            updateCase() {
                this.$refs['Case'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('https://iview-laravel.test/api/case', this.Case).then((response) => {
           ...
           * */
            deleteCase(id) {
                this.$ajax.delete('https://iview-laravel.test/api/case/' + id).then((response) => {
