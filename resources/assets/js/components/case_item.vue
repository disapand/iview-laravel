    ...
    export default {
        ...
        created() {
            if (this.$route.params.id) {
                this.$ajax.get('http://zetin.cn/api/case/' + this.$route.params.id + '?include=Imgs').then((response) => {
        ...
        methods: {
            ...
            * */
            ...
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://zetin.cn/api/caseImg/' + id).then((response) => {
            ...
            * */
            ...
            updateCase() {
                this.$refs['Case'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://zetin.cn/api/case', this.Case).then((response) => {
           ...
           * */
            deleteCase(id) {
                this.$ajax.delete('http://zetin.cn/api/case/' + id).then((response) => {
