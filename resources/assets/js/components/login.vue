        ...
        methods: {
            authorization() {
                this.$refs['user'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('https://iview-laravel.test/api/authorizations', this.user).then( (res) => {
...
<style scoped>
    .bg {
        width: 100%;
        height: 100%;
        background: url("https://iview-laravel.test/images/login_bg.jpg") center no-repeat;
    }
