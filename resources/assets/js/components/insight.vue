<template>
    <div>
        ...
        <div>
            <i-table ref="insight" border :columns="col" :data="insight" stripe :highlight-row=false @on-selection-change="selectedChange"
