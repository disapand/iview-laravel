            ...
            this.$ajax.get('http://www.zetin.cn/api/insight').then((response) => {
                ...
                if (this.$route.params.currentPage == undefined || this.$route.params.currentPage == 1) {
                    ...
                    if (this.condition && this.search) {
                        uri = 'http://www.zetin.cn/api/insight/' + this.condition + '/' + this.search + '?page=' + this.total
                    } else {
                        uri = 'http://www.zetin.cn/api/insight?page=' + this.total
                    }
                    ...
                    let uri
                    if (this.condition && this.search) {
                        uri = 'http://www.zetin.cn/api/insight/' + this.condition + '/' + this.search + '?page=' + this.$route.params.currentPage
                    } else {
                        uri = 'http://www.zetin.cn/api/insight?page=' + this.$route.params.currentPage
                    }
                    this.$ajax.get(uri).then((response) => {
                        this.insight = response.data.data
                        this.loading = false
