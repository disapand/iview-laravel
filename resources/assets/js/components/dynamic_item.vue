...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            * */
            ...
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://www.zetin.cn/api/dynamicImg/' + id).then((response) => {
            ...
            * */
            ...
            updateDynamic() {
                this.$refs['dynamic'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://www.zetin.cn/api/dynamic', this.dynamic).then((response) => {
           ...
           * */
            deleteDynamic(id) {
                this.$ajax.delete('http://www.zetin.cn/api/dynamic/' + id).then((response) => {
