...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            back() {
                this.$router.push({'name': 'newspaper', params: {currentPage: this.currentPage}})
            },
            /*
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://www.zetin.cn/api/newspaperImg/' + id).then((response) => {
            ...
            * */
            deleteNewspaper(id) {
                this.$ajax.delete('http://www.zetin.cn/api/newspaper/' + id).then((response) => {
            ...
            * */
            updateNewspaper() {
                this.$refs['newspaper'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://www.zetin.cn/api/newspaper', this.newspaper).then((response) => {
        ...
        created() {
            ...
            * */
            if (this.$route.params.id) {
                this.$ajax.get('http://www.zetin.cn/api/newspaper/' + this.$route.params.id + '?include=newspaperResourceImgs').then((response) => {
