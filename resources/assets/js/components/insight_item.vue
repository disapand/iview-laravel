    ...
    export default {
        ...
        created() {
            if (this.$route.params.id) {
                this.$ajax.get('http://zetin.cn/api/insight/' + this.$route.params.id + '?include=Imgs').then((response) => {
        ...
        methods: {
            ...
            * */
            ...
            updateInsight() {
                this.$refs['insight'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://zetin.cn/api/insight', this.insight).then((response) => {
           ...
           * */
            deleteInsight(id) {
                this.$ajax.delete('http://zetin.cn/api/insight/' + id).then((response) => {
