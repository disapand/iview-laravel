    ...
    export default {
        ...
        created() {
            if (this.$route.params.id) {
                this.$ajax.get('http://iview-laravel.test/api/insight/' + this.$route.params.id + '?include=Imgs').then((response) => {
        ...
        methods: {
            ...
            * */
            ...
            updateInsight() {
                this.$refs['insight'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://iview-laravel.test/api/insight', this.insight).then((response) => {
           ...
           * */
            deleteInsight(id) {
                this.$ajax.delete('http://iview-laravel.test/api/insight/' + id).then((response) => {
