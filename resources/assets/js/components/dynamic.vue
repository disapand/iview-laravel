...
<script>
    export default {
        ...
        created() {
            this.$ajax.get('http://zetin.cn/api/dynamic').then((response) => {
        ...
        methods: {
            ...
            remove(row, index) {
                this.$ajax.delete('http://zetin.cn/api/dynamic/' + row.id).then((response) => {
            ...
            searchDynamic() {
                ...
                this.$ajax.get('http://zetin.cn/api/dynamic/' + this.condition + '/' + this.search).then((response) => {
                    this.dynamic = response.data.data
                    this.total = response.data.meta.pagination.total
                    this.all = true
