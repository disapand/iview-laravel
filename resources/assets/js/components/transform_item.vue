            ...
            <Card style="width: 30%; display: inline-block; vertical-align: top;">
                ...
                <form-item>
                    <upload multiple type="drag"
                            name="img"
                            action="https://iview-laravel.test/api/transformImg"
...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('https://iview-laravel.test/api/transformImg/' + id).then((response) => {
                ...
                this.$Modal.info({
                    ...
                    render: (h) => {
                        return h('div', [
                            h('upload', {
                                props: {
                                    action: 'https://iview-laravel.test/api/transformImgUpdate',
                                    type: 'drag',
                                    name: 'img',
                                    data: this.img,
                                    'show-upload-list': false,
            ...
            * */
            deleteTransform(id) {
                this.$ajax.delete('https://iview-laravel.test/api/transform/' + id).then((response) => {
            ...
            updateTransform() {
                this.$refs['transform'].validate((valid) => {
                    if (valid) {
                        ...
                        this.$ajax.post('https://iview-laravel.test/api/transform', this.transform).then((response) => {
        ...
        created() {
            ...
            * */
            if (this.$route.params.id) {
                this.$ajax.get('https://iview-laravel.test/api/transform/' + this.$route.params.id + '?include=transformResourceImgs').then((response) => {
