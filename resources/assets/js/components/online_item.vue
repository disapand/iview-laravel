...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://www.zetin.cn/api/onlineImg/' + id).then((response) => {
            ...
            * */
            deleteOnline(id) {
                this.$ajax.delete('http://www.zetin.cn/api/online/' + id).then((response) => {
            ...
            * */
            updateOnline() {
                this.$refs['online'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://www.zetin.cn/api/online', this.online).then((response) => {
