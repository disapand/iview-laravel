...
<script>
    export default {
        ...
        methods: {
            ...
            * */
            deleteImg(id) {
                this.$Modal.confirm({
                    ...
                    * */
                    onOk: () => {
                        this.$ajax.delete('http://iview-laravel.test/api/outdoorImg/' + id).then((response) => {
            ...
            * */
            deleteOutdoor(id) {
                this.$ajax.delete('http://iview-laravel.test/api/outdoor/' + id).then((response) => {
            ...
            * */
            updateOutdoor() {
                this.$refs['outdoor'].validate((valid) => {
                    if (valid) {
                        this.$ajax.post('http://iview-laravel.test/api/outdoor', this.outdoor).then((response) => {
        ...
        created() {
            ...
            * */
            if (this.$route.params.id) {
                this.$ajax.get('http://iview-laravel.test/api/outdoor/' + this.$route.params.id + '?include=outdoorResourceImgs').then((response) => {
