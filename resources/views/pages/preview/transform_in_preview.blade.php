        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <!-- page-title start -->
                    <!-- ================ -->
                    <h1 class="page-title margin-top-clear">{{ $transform->name }}</h1>
                    <!-- page-title end -->
                                        ...
                                        <div class="tab-content padding-top-clear padding-bottom-clear">
                                            <div class="tab-pane fade in active" id="h2tab1">
                                                <p style="line-height: 32px;margin-top: 32px;">
                                                    位置：{{ $transform->city }}<br>
                                                    类别：{{ $transform->category }}<br>
                                                    类型：{{ $transform->form }}<br>
                                                    规格：{{ $transform->format }}<br>
                                                    媒体描述：{!! str_replace(PHP_EOL, '<br />', $transform->detail ) !!}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
