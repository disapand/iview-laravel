            ...
            <div class="row">
                ...
                <div class="main col-md-12">
                    ...
                    <div class="sorting-filters">
                        <form class="form-inline" method="post" action="{{ route('online.search') }}" id="search">
                            {{ csrf_field() }}
                            ...
                            <div class="col-md-4 col-sm-6 masonry-grid-item">
                                <div class="listing-item">
                                    <div class="overlay-container" style="height: 365px;">
                                        ...
                                        @endif
                                        <a href="{{ route('online.showPreview', [$online->id]) }}" class="overlay small">
                                            <i class="fa fa-plus"></i>
                                            <span>了解详情</span>
                                        </a>
                                    </div>
                                    <div class="listing-item-body clearfix">
                                        <h3 class="title"><a href="{{ route('online.show', [$online->id]) }}">{{ mb_strimwidth($online->name, 0, 36, '...', 'utf-8') }}</a></h3>
                                    </div>
                                </div>
                            </div>
                        @endforeach
