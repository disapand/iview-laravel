                ...
                <div class="col-md-3">
                    ...
                    <div class="header-left clearfix">
                        ...
                        <div style="display: inline-block;margin-left: 20px;">
                            <span style="color: #fff;text-decoration: none;cursor: default;">测试版</span>
                        </div>
                    </div>
                    <!-- header-left end -->
                                        ...
                                        <ul class="nav navbar-nav" style="margin-left: 50%;">
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li><a href="{{ route('newspaper.preview') }}"><i
                                                                    class="icon-right-open"></i>报刊杂志</a></li>
                                                    <li><a href="{{ route('television.preview') }}"><i
                                                                    class="icon-right-open"></i>电视媒体</a></li>
                                                    <li><a href="{{ route('outdoor.preview') }}"><i class="icon-right-open"></i>户外媒体</a>
                                                    </li>
                                                    <li><a href="{{ route('transform.preview') }}"><i
                                                                    class="icon-right-open"></i>交通媒体</a></li>
                                                    <li><a href="{{ route('online.preview') }}"><i class="icon-right-open"></i>线上媒体</a>
                                                    </li>
                                                    <li><a href="{{ route('internetCelebrity.preview') }}"><i
